...
We have a 30-minutes weekly developer meetings on Tuesdays at 11:30 AM Central US time (9:30 AM Pacific Time / 5:30 PM UK time). The meeting is on https://whereby.com/cb-geo. Please update [Trello weekly meeting](https://trello.com/b/fU8TDAb8/cb-geo-mpm-weekly-team-meetings) minutes the Monday prior to the weekly meeting. Let us know before hand if you can make it to the meeting, by filling the commitment to attend card. Slack will automatically remind you at 8 AM Central Time on Monday to update the Trello page.
...
Please review others' comments on Trello before the start of the meeting. We want to discuss more critical issues during this in-person meeting. Avoid bringing up issues, which are not written in the agenda, when you have something to report, its better to document it on GitHub/Discourse/Trello than to update a few of us.